...
public class Consumer {
    ...
    public RequestResponsePact createPact(PactDslWithProvider builder) {
        ...
        //creating body
        //API request POST - ADD ,GET - FETCH , PUT-UPDATE , DELETE
        //POST - http://localhost:8585/api/user
       /* {
            "id":123,
            "FirstName":"String"
                "LastName":"String"
...
//set request body
        ...
        reqBody.put("id", 123);
        reqBody.put("firstName", "Zone");
        reqBody.put("lastName", "Method");
        reqBody.put("email","Zone@email.com");
